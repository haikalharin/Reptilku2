package com.example.reptilku.Komunitas.Jakarta;
   ...
   KomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reptile.add(new Home("FACEBOOK",
                R.drawable.fb_jakarta, "JAKARTA","PERJAKA(pecinta reptil jakarta)",
                "https://www.facebook.com/groups/330747397501173/"));
        reptile.add(new Home("KASKUS",
                R.drawable.kk_jakarta, "JAKARTA","Rumah Pecinta Reptil Regional DKI Jakarta",
                "https://www.kaskus.co.id/thread/000000000000000013165786/regional-9829-rumah-para-pecinta-reptil-regional-dki-jakarta-9829/"));
        reptile.add(new Home("INSTAGRAM",
                R.drawable.ig_jakarta, "JAKARTA","PERJAKA(pecinta reptil jakarta)",
                "https://www.instagram.com/pecinta_reptil_jakarta/"));
        reptile.add(new Home("TWITTER",
                R.drawable.twt_jakarta, "JAKARTA","KPJR(KOMUNITAS PECINTA REPTIL JAKARTA)",
                "https://twitter.com/kprj_9"));
        ...
        orderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(JakartaActivity.this, HomeDetailActivity.class);
